...
local function CreateMenu()
	...
	UISpellsPVEConfig:SetScale(.875)
			...
			if (spellID) then
				...
				if spellCheck then
					...
					if type(spellID) == "number" then
						...
						if (instanceType ==  "arena" or instanceType == "pvp") then
							if duration then
								if name then  aString1 = substring(GetSpellInfo(spellID), 0, 14)..": "..substring(prio, 0, 5)..": "..math.floor(duration) else aString1 = "REMOVED: "..spellID end
								local aString2 = " ("..instanceType..")"
								local cutString1 = substring(aString1, 0, 23);
								local cutString2 = substring(aString2, 0, 23);
								local aString3 = cutString1.."\n"..cutString2
								...
								if name then aString1 = substring(name, 0, 17)..": "..substring(prio, 0, 6) else aString1 = "REMOVED: "..spellID end
								local aString2 = " ("..instanceType..")"
								local cutString1 = substring(aString1, 0, 23);
								local cutString2 = substring(aString2, 0, 23);
								local aString3 = cutString1.."\n"..cutString2
						...
						elseif zone then
							...
							if name then aString = substring(name, 0, 17)..": "..substring(prio, 0, 6) else aString = "REMOVED: "..spellID end
							local cutString = substring(aString, 0, 23);
							if customname then
								spellCheck.text:SetText(cutString.."\n".."("..customname..")");
							else
